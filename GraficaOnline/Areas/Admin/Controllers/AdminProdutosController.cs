...
namespace GraficaOnline.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class AdminProdutosController : Controller
    {
        ...
        {
            var resultado = _context.Produtos.AsNoTracking()
                           .AsQueryable();
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,Descricao,ImagemUrl,ImagemThumbnailUrl,Marca,Quantidade,IsProdutoPreferida,ValorCompra,ValorVenda,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Nome,Descricao,ImagemUrl,ImagemThumbnailUrl,Marca,Quantidade,IsProdutoPreferida,ValorCompra,ValorVenda,CategoriaId")] Produto produto)
        {
